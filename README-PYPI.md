...
* [bulk_create](https://github.com/thetradedesk/ttd-workflows-python/blob/master/docs/sdks/adgroups/README.md#bulk_create) - Create a list of ad groups with required fields. `ValidateInputOnly` value should be the same for all ad groups.
...
* [get_status](https://github.com/thetradedesk/ttd-workflows-python/blob/master/docs/sdks/bulkjobs/README.md#get_status) - Get the status of a bulk job you submitted earlier
