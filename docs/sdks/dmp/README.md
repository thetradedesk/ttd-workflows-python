...
with TtdWorkflows(
    ...
    res = tw_client.dmp.get_first_party_data_job(request={
        "advertiser_id": "<id>",
        "name_filter": "<value>",
        "query_shape": "<value>",
        "callback_input": {
...
**[operations.GetFirstPartyDataJobResponse](../../models/operations/getfirstpartydatajobresponse.md)**
...
with TtdWorkflows(
    ...
    res = tw_client.dmp.get_third_party_data_job(request={
        "partner_id": "<id>",
        "query_shape": "<value>",
        "callback_input": {
...
**[operations.GetThirdPartyDataJobResponse](../../models/operations/getthirdpartydatajobresponse.md)**
