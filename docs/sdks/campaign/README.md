    ...
    res = workflows.campaign.create(request=ttd_workflows.CampaignCreateWorkflowInputWithValidation(
        primary_input=ttd_workflows.CampaignCreateWorkflowPrimaryInput(
            ...
            tertiary_goal=ttd_workflows.CampaignWorkflowROIGoalInput(
                ...
                cpc_in_advertiser_currency=8093.04,
                ctr_in_percent=1502.33,
                nielsen_otp_in_percent=6363.35,
                cpa_in_advertiser_currency=8365.18,
                return_on_ad_spend_percent=7814.79,
                vcr_in_percent=7849.85,
                viewability_in_percent=None,
                vcpm_in_advertiser_currency=None,
                cpcv_in_advertiser_currency=9519.81,
                miaozhen_otp_in_percent=6125.66,
            ),
            advertiser_id="<id>",
            name="<value>",
        ...
        advanced_input=ttd_workflows.CampaignCreateWorkflowAdvancedInput(
            ...
            pass_through_fee_card=ttd_workflows.CampaignCreateWorkflowPassThroughFeeCardInput(
                start_date_utc=parse_datetime("2025-01-31T21:08:52.654Z"),
                pass_through_fees=[],
            ),
        ),
        ad_groups=[
            ...
            ttd_workflows.CampaignCreateWorkflowInput(
                primary_input=ttd_workflows.CampaignCreateWorkflowPrimaryInput(
                    ...
                    tertiary_goal=ttd_workflows.CampaignWorkflowROIGoalInput(
                        maximize_reach=True,
                        maximize_ltv_incremental_reach=False,
                        cpc_in_advertiser_currency=8906.82,
                        ctr_in_percent=None,
                        nielsen_otp_in_percent=8446.84,
                        cpa_in_advertiser_currency=8662.23,
                        return_on_ad_spend_percent=6123.61,
                        vcr_in_percent=25.32,
                        viewability_in_percent=4889.32,
                        vcpm_in_advertiser_currency=5258.8,
                        cpcv_in_advertiser_currency=2553.01,
                        miaozhen_otp_in_percent=1142.91,
                    ),
                    advertiser_id="<id>",
                    name="<value>",
                    ...
                    campaign_incremental_reach_setting=ttd_workflows.CampaignCreateWorkflowIncrementalReachCampaignSetting(
                        ...
                        realytics_reach_setting=ttd_workflows.RealyticsReachSettingInput(
                            ...
                            realytics_entertainment_input=ttd_workflows.RealyticsEntertainmentType.IPTV,
                        ),
                        tv_squared_reach_setting=ttd_workflows.IncrementalReachBrandInput(
                            id=284766,
                            name="<value>",
                ...
                advanced_input=ttd_workflows.CampaignCreateWorkflowAdvancedInput(
                    ...
                    include_defaults_from_advertiser=False,
                    pass_through_fee_card=ttd_workflows.CampaignCreateWorkflowPassThroughFeeCardInput(
                        start_date_utc=parse_datetime("2023-11-10T21:02:27.780Z"),
                        pass_through_fees=[],
                    ),
                ),
                ad_groups=[
            ...
            ttd_workflows.CampaignUpdateWorkflowInput(
                ...
                primary_input=ttd_workflows.CampaignUpdateWorkflowPrimaryInput(
                    ...
                    tertiary_goal=ttd_workflows.CampaignWorkflowROIGoalInput(
                        maximize_reach=False,
                        maximize_ltv_incremental_reach=None,
                        cpc_in_advertiser_currency=6610.8,
                        ctr_in_percent=798.77,
                        nielsen_otp_in_percent=7847.88,
                        cpa_in_advertiser_currency=6180.15,
                        return_on_ad_spend_percent=7329.7,
                        vcr_in_percent=9103.24,
                        viewability_in_percent=2359.55,
                        vcpm_in_advertiser_currency=6489.19,
                        cpcv_in_advertiser_currency=8265.87,
