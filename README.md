...
| --------- | ----------------------------------------------- | ------------------------------------------------------------ |
| `prod`    | `https://api.thetradedesk.com/workflows`        | [Prod server] A RESTful service for commonly used workflows. |
| `sandbox` | `https://ext-api.sb.thetradedesk.com/workflows` | [Test server] A RESTful service for commonly used workflows. |
