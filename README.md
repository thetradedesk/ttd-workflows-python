...
[`TtdWorkflowsError`](./src/ttd_workflows/models/errors/ttdworkflowserror.py) is the base class for all HTTP error responses. It has the following properties:
...
### Error Classes
**Primary errors:**
* [`TtdWorkflowsError`](./src/ttd_workflows/models/errors/ttdworkflowserror.py): The base class for HTTP error responses.
  * [`ProblemDetailsError`](./src/ttd_workflows/models/errors/problemdetailserror.py): Bad Request.
...
**Inherit from [`TtdWorkflowsError`](./src/ttd_workflows/models/errors/ttdworkflowserror.py)**:
* [`ResponseValidationError`](./src/ttd_workflows/models/errors/responsevalidationerror.py): Type mismatch between the response data and the expected Pydantic model. Provides access to the Pydantic validation error via the `cause` attribute.
