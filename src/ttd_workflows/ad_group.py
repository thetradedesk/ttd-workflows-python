...
class AdGroup(BaseSDK):
    def create_ad_groups_job(
        ...
        *,
        request: Optional[
            Union[
                components.AdGroupBulkCreateWorkflowInputWithValidation,
                components.AdGroupBulkCreateWorkflowInputWithValidationTypedDict,
            ]
        ] = None,
    ...
    ) -> operations.CreateAdGroupsJobResponse:
        ...
        if not isinstance(request, BaseModel):
            request = utils.unmarshal(
                request,
                Optional[components.AdGroupBulkCreateWorkflowInputWithValidation],
            )
        request = cast(
            Optional[components.AdGroupBulkCreateWorkflowInputWithValidation], request
        )
        ...
        if utils.match_response(http_res, "202", "application/json"):
            return operations.CreateAdGroupsJobResponse(
    ...
    def update_ad_groups_job(
        ...
        *,
        request: Optional[
            Union[
                components.AdGroupBulkUpdateWorkflowInputWithValidation,
                components.AdGroupBulkUpdateWorkflowInputWithValidationTypedDict,
            ]
        ] = None,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        ...
        if not isinstance(request, BaseModel):
            request = utils.unmarshal(
                request,
                Optional[components.AdGroupBulkUpdateWorkflowInputWithValidation],
            )
        request = cast(
            Optional[components.AdGroupBulkUpdateWorkflowInputWithValidation], request
        )
        ...
        response_data: Any = None
        if utils.match_response(http_res, "202", "application/json"):
            return operations.UpdateAdGroupsJobResponse(
                standard_job_submit_response=unmarshal_json_response(
                    Optional[components.StandardJobSubmitResponse], http_res
                ),
                http_meta=components.HTTPMetadata(request=req, response=http_res),
