...
class GraphQLRequest(BaseSDK):
    def submit_graph_ql_request(
        ...
        *,
        request: Optional[
            Union[
                components.GraphQLRequestInput, components.GraphQLRequestInputTypedDict
            ]
        ] = None,
    ...
    ) -> operations.SubmitGraphQlRequestResponse:
        ...
        if not isinstance(request, BaseModel):
            request = utils.unmarshal(request, Optional[components.GraphQLRequestInput])
        request = cast(Optional[components.GraphQLRequestInput], request)
        ...
        req = self._build_request(
            ...
            get_serialized_body=lambda: utils.serialize_request_body(
                request, False, True, "json", Optional[components.GraphQLRequestInput]
            ),
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return operations.SubmitGraphQlRequestResponse(
                object=unmarshal_json_response(
                    Optional[operations.SubmitGraphQlRequestResponseBody], http_res
                ),
    ...
    def submit_graph_ql_query_job(
        ...
        *,
        request: Optional[
            Union[
                components.GraphQlQueryJobInput,
                components.GraphQlQueryJobInputTypedDict,
            ]
        ] = None,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
        http_headers: Optional[Mapping[str, str]] = None,
    ) -> operations.SubmitGraphQlQueryJobResponse:
        ...
        if not isinstance(request, BaseModel):
            request = utils.unmarshal(
                request, Optional[components.GraphQlQueryJobInput]
            )
        request = cast(Optional[components.GraphQlQueryJobInput], request)
        ...
        req = self._build_request(
            ...
            security=self.sdk_configuration.security,
            get_serialized_body=lambda: utils.serialize_request_body(
                request, False, True, "json", Optional[components.GraphQlQueryJobInput]
            ),
            timeout_ms=timeout_ms,
        )
        ...
        response_data: Any = None
        if utils.match_response(http_res, "200", "application/json"):
            return operations.SubmitGraphQlQueryJobResponse(
                graph_ql_query_job_response=unmarshal_json_response(
                    Optional[components.GraphQlQueryJobResponse], http_res
                ),
                http_meta=components.HTTPMetadata(request=req, response=http_res),
            )
        if utils.match_response(
