...
class GraphQLRequest(BaseSDK):
    ...
    def submit_graph_ql_query_job(
        ...
        *,
        request: Optional[
            Union[models.GraphQlQueryJobInput, models.GraphQlQueryJobInputTypedDict]
        ] = None,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
        ...
        if not isinstance(request, BaseModel):
            request = utils.unmarshal(request, Optional[models.GraphQlQueryJobInput])
        request = cast(Optional[models.GraphQlQueryJobInput], request)
        ...
        response_data: Any = None
        if utils.match_response(http_res, "200", "application/json"):
            return utils.unmarshal_json(http_res.text, models.GraphQlQueryJobResponse)
        if utils.match_response(
            http_res, ["400", "401", "403", "404"], "application/json"
        ):
            response_data = utils.unmarshal_json(
