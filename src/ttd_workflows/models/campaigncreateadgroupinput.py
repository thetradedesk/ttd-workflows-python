...
class CampaignCreateAdGroupInputTypedDict(TypedDict):
    name: Nullable[str]
    ...
    advanced_settings: NotRequired[CampaignCreateAdGroupAdvancedSettingsInputTypedDict]


class CampaignCreateAdGroupInput(BaseModel):
    name: Nullable[str]
    ...
    advanced_settings: Annotated[
        Optional[CampaignCreateAdGroupAdvancedSettingsInput],
