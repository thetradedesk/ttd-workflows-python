...
class CampaignCreateWorkflowAdGroupAdvancedInputTypedDict(TypedDict):
...
class CampaignCreateWorkflowAdGroupAdvancedInput(BaseModel):
...
try:
    CampaignCreateWorkflowAdGroupAdvancedInput.model_rebuild()
except NameError:
    pass
