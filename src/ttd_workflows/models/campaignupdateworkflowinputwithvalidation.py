...
class CampaignUpdateWorkflowInputWithValidation(BaseModel):
    ...
    def serialize_model(self, handler):
        optional_fields = set(["primaryInput", "advancedInput", "validateInputOnly"])
        nullable_fields = set(["id", "validateInputOnly"])
...
try:
    CampaignUpdateWorkflowInputWithValidation.model_rebuild()
except NameError:
    pass
