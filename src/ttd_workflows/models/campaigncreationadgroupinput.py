...
class CampaignCreationAdGroupInputTypedDict(TypedDict):
    name: str
    ...
    budget: NotRequired[AdGroupBudgetInputTypedDict]
    ...
    audience_targeting: NotRequired[AdGroupAudienceTargetingInputTypedDict]
    ...
    advanced_settings: NotRequired[AdGroupAdvancedSettingsInputTypedDict]


class CampaignCreationAdGroupInput(BaseModel):
    name: str
    ...
    budget: Optional[AdGroupBudgetInput] = None
    ...
    audience_targeting: Annotated[
        Optional[AdGroupAudienceTargetingInput],
    ...
    advanced_settings: Annotated[
        Optional[AdGroupAdvancedSettingsInput], pydantic.Field(alias="advancedSettings")
    ] = None
