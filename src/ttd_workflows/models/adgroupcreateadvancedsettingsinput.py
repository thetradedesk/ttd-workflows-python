...
class AdGroupCreateAdvancedSettingsInputTypedDict(TypedDict):
    ...
    flights: NotRequired[Nullable[List[AdGroupCreateAdGroupFlightInputTypedDict]]]


class AdGroupCreateAdvancedSettingsInput(BaseModel):
    ...
    flights: OptionalNullable[List[AdGroupCreateAdGroupFlightInput]] = UNSET
