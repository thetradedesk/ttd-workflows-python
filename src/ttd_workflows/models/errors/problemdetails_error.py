...
import httpx
import pydantic
from ttd_workflows.models.components import problemdetails as components_problemdetails
from ttd_workflows.models.errors import TtdWorkflowsError
...
class ProblemDetailsErrorData(BaseModel):
    ...
    additional_properties: Annotated[
        Optional[Dict[str, components_problemdetails.ProblemDetails]],
        pydantic.Field(exclude=True),
    ] = None


class ProblemDetailsError(TtdWorkflowsError):
