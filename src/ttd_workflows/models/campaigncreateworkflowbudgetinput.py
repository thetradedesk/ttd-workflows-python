...
class CampaignCreateWorkflowBudgetInputTypedDict(TypedDict):
...
class CampaignCreateWorkflowBudgetInput(BaseModel):
...
try:
    CampaignCreateWorkflowBudgetInput.model_rebuild()
except NameError:
    pass
