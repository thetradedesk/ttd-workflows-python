...
class SDKCampaign(BaseSDK):
    def post_campaign(
        self,
        *,
        request: Optional[
            Union[models.CampaignCreationInput, models.CampaignCreationInputTypedDict]
        ] = None,
        ...
        if not isinstance(request, BaseModel):
            request = utils.unmarshal(request, Optional[models.CampaignCreationInput])
        request = cast(Optional[models.CampaignCreationInput], request)
        ...
        req = self._build_request(
            ...
            get_serialized_body=lambda: utils.serialize_request_body(
                request, False, True, "json", Optional[models.CampaignCreationInput]
            ),
    ...
    async def get_campaign_id_version_async(
        self,
        *,
        id: str,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
