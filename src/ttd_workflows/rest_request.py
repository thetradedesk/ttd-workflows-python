...
class RESTRequest(BaseSDK):
    def submit_rest_request(
        ...
        *,
        request: Optional[
            Union[
                components.CallRestAPIWorkflowInput,
                components.CallRestAPIWorkflowInputTypedDict,
            ]
        ] = None,
    ...
    ) -> operations.SubmitRestRequestResponse:
        ...
        if not isinstance(request, BaseModel):
            request = utils.unmarshal(
                request, Optional[components.CallRestAPIWorkflowInput]
            )
        request = cast(Optional[components.CallRestAPIWorkflowInput], request)
        ...
        req = self._build_request(
            ...
            get_serialized_body=lambda: utils.serialize_request_body(
                ...
                True,
                "json",
                Optional[components.CallRestAPIWorkflowInput],
            ),
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return operations.SubmitRestRequestResponse(
                object=unmarshal_json_response(
                    Optional[operations.SubmitRestRequestResponseBody], http_res
                ),
