...
class JobStatus(BaseSDK):
    def get_graph_ql_query_job_status(
        ...
        *,
    ...
    ) -> operations.GetGraphQlQueryJobStatusResponse:
        ...
        request = operations.GetGraphQlQueryJobStatusRequest(
            id=id,
        )
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return operations.GetGraphQlQueryJobStatusResponse(
                graph_ql_query_job_retrieval_response=unmarshal_json_response(
                    Optional[components.GraphQLQueryJobRetrievalResponse], http_res
                ),
    ...
    def get_job_status(
        ...
        *,
        ...
        timeout_ms: Optional[int] = None,
        http_headers: Optional[Mapping[str, str]] = None,
    ) -> operations.GetJobStatusResponse:
        ...
        response_data: Any = None
        if utils.match_response(http_res, "200", "application/json"):
            return operations.GetJobStatusResponse(
                standard_job_status_response=unmarshal_json_response(
                    Optional[components.StandardJobStatusResponse], http_res
                ),
                http_meta=components.HTTPMetadata(request=req, response=http_res),
            )
        if utils.match_response(
