...
class Dmp(BaseSDK):
    def get_first_party_data_job(
        ...
        *,
        request: Optional[
            Union[
                components.FirstPartyDataInput, components.FirstPartyDataInputTypedDict
            ]
        ] = None,
    ...
    ) -> operations.GetFirstPartyDataJobResponse:
        ...
        if not isinstance(request, BaseModel):
            request = utils.unmarshal(request, Optional[components.FirstPartyDataInput])
        request = cast(Optional[components.FirstPartyDataInput], request)
        ...
        req = self._build_request(
            ...
            get_serialized_body=lambda: utils.serialize_request_body(
                request, False, True, "json", Optional[components.FirstPartyDataInput]
            ),
        ...
        if utils.match_response(http_res, "202", "application/json"):
            return operations.GetFirstPartyDataJobResponse(
    ...
    def get_third_party_data_job(
        ...
        *,
        request: Optional[
            Union[
                components.ThirdPartyDataInput, components.ThirdPartyDataInputTypedDict
            ]
        ] = None,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
        http_headers: Optional[Mapping[str, str]] = None,
    ) -> operations.GetThirdPartyDataJobResponse:
        ...
        if not isinstance(request, BaseModel):
            request = utils.unmarshal(request, Optional[components.ThirdPartyDataInput])
        request = cast(Optional[components.ThirdPartyDataInput], request)
        ...
        req = self._build_request(
            ...
            security=self.sdk_configuration.security,
            get_serialized_body=lambda: utils.serialize_request_body(
                request, False, True, "json", Optional[components.ThirdPartyDataInput]
            ),
            timeout_ms=timeout_ms,
        )
        ...
        response_data: Any = None
        if utils.match_response(http_res, "202", "application/json"):
            return operations.GetThirdPartyDataJobResponse(
                standard_job_submit_response=unmarshal_json_response(
                    Optional[components.StandardJobSubmitResponse], http_res
                ),
                http_meta=components.HTTPMetadata(request=req, response=http_res),
